...
export const ERROR_PRIORITY = {
  ...
  'Apple Music session expired — tap Retry to reconnect': 2,
...
export const ERRORS = {
  ...
  APPLE_CONNECT: 'Could not connect to Apple Music — tap Retry',
  DRM_KEY: 'Apple Music session expired — tap Retry to reconnect',
  NEEDS_ATTENTION: 'Player needs attention — tap to reconnect Apple Music',
