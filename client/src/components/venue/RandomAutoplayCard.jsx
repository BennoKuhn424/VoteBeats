    ...
    <div className="mb-6 p-6 bg-white rounded-xl border border-zinc-200 shadow-sm">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center justify-center gap-2 text-sm font-semibold px-4 py-2.5 rounded-lg bg-violet-600 text-white hover:bg-violet-700 transition-colors min-h-[44px] disabled:opacity-50"
        >
